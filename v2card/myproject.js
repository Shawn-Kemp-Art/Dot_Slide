...
var orient=R.random_int(2, 2); // decide on orientation 
//orient=2;
var halfsize = R.random_int(2, 2);
...
//Set the line color
linecolor={"Hex":"#FFFFFF", "Name":"Smooth White"};
...
function frameIt(z){
        ...
        //sheet[z].style = {fillColor: colors[z].Hex, strokeColor: linecolor.Hex, strokeWidth: 2,shadowColor: new Color(0,0,0,[0.3]),shadowBlur: 20,shadowOffset: new Point((stacks-z)*2.3, (stacks-z)*2.3)};
        sheet[z].style = {fillColor: colors[z].Hex, strokeColor: linecolor.Hex, strokeWidth: 2};
}
